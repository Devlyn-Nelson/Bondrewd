...
impl Test {
    const ONE_MAX: u8 = 2_u8.pow(3) - 1;
    const TWO_MAX: i8 = 2_i8.pow(4 - 1) - 1;
    const THREE_MAX: u16 = 2_u16.pow(9) - 1;
    const FOUR_MAX: i16 = 2_i16.pow(14 - 1) - 1;
    const FIVE_MAX: u32 = 2_u32.pow(30) - 1;
    const SIX_MAX: i32 = 2_i32.pow(27 - 1) - 1;
    const SEVEN_MAX: u64 = 2_u64.pow(56) - 1;
    const EIGHT_MAX: i64 = 2_i64.pow(43 - 1) - 1;
    ...
    pub fn fix(&self) -> Self {
        Self {
            ...
            three: self.three.clamp(0, Self::THREE_MAX),
            four: self.four.clamp(-Self::FOUR_MAX, Self::FOUR_MAX - 1),
            five: self.five.clamp(0, Self::FIVE_MAX),
            six: self.six.clamp(-Self::SIX_MAX, Self::SIX_MAX - 1),
            seven: self.seven.clamp(0, Self::SEVEN_MAX),
            eight: self.eight.clamp(-Self::EIGHT_MAX, Self::EIGHT_MAX - 1),
            nine: self.nine.clamp(0, Self::NINE_MAX),
...
fn nothing() {
    ...
    let correct = [
        ...
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b01111111, 0b00000000, 0b00000000, 0b00000000,
...
fn nothing_2() {
    ...
    let correct = [
        ...
        0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000,
        0b00000000, 0b00000000, 0b00000000, 0b10000000, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
        0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111,
